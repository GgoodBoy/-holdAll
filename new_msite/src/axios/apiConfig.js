let env,inviteFriendDoorwayPage,appId,privacyAgreement,registerAgreement,downLoad
if (process.env.NODE_ENV == 'development'){
    ...
    downLoad = 'http://172.16.120.1/h5/download/index.html'
}
else{
    if(process.env.argv=='beta'){
        ...
        privacyAgreement = 'https://scm.youfushuyuan.com/invitation/privacyAgreement.html';
        registerAgreement = 'https://scm.youfushuyuan.com/invitation/registerAgreement.html'
        downLoad = 'https://scm.youfushuyuan.com/h5/download/index.html'
    }else{
        env = 'prod';
        ...
        downLoad = 'https://xgxm.xueguoxue.com/h5/download/index.html'
    }
}
export default {
    downLoad,
    ...
    getCoursesListByClassIfy: '/mobileCourses/getCoursesListByClassIfy',//根据课程分类查询课程列表
    getPopularCourseList: '/mobileCourses/getPopularCourseList',//获取热门课程列表
    getTimeLimitPurchaseCourseList: '/mobileCourses/getTimeLimitPurchaseCourseList',//查询体验课程列表
    getGuessLikeCourseList: '/mobileCourses/getGuessLikeCourseList',//获取猜你喜欢列表
    ...
    getPeriodsInfo: '/mobileCourses/getPeriodsInfo',//根据课时ID查询课时信息
    getResoursePlayUrl: '/mobileCourses/getResoursePlayUrl',//获取课程音频视频
    setPeriodPoint: '/mobileCourses/setPeriodPoint',//课时点赞
    setComentPoint: '/mobileCourses/setComentPoint',//评论点赞
    addComment: '/mobileCourses/addComment2',//添加评论
    getOrderForCourseInfo: '/mobileCourses/getOrderForCourseInfo',//查询订单页数据
    getPurchasedPageList: '/mobileCourses/getPurchasedPageList',//查询用户已购课程页面
    getPurchasedCourseList: '/mobileCourses/getPurchasedCourseList',//查询用户已购课程列表(包含免费课程列表)
    getBrowsingHistoryList: '/mobileCourses/getBrowsingHistoryList',//查询用户课程浏览记录列表
    getListForRecommend: '/mobileCourses/getListForRecommend',//推荐位列表
    ...
    searchCourseList: '/mobileCourses/searchCourseList',//根据key搜索课程
    ...
    buyCourse: '/mobileCourses/buyCourse',//购买课程
    savePeriodStudyRecords: '/user/savePeriodStudyRecords',//保存用户学习进度
    getTrySeePeriodList: '/mobileCourses/getTrySeePeriodList',//免费试听免费试看
    ...
    getCommentList: '/mobileCourses/getCommentList2',//课时详情页面查询评论列表
    getCourseState: '/mobileCourses/getCourseState',//查询课程状态
    ...
    loginBySMS: '/login/loginBySMS',//短信登录
    getRelatedCourseList: '/mobileCourses/getRelatedCourseList',//课程-查询关联课程列表
    getEssentialCommentPage: '/mobileCourses/getEssentialCommentPage',//课程-查询精华评论列表
    ...
    verifyTimeLimitExpired: '/mobileCourses/verifyTimeLimitExpired',//验证秒杀是否已下架（过期）
    ...
    getCourseShareModelState: '/mobileCourses/getCourseShareModelState',//查询是否设置课程分享模板
    getShareModelList: '/mobileCourses/getShareModelList',//查询课程分享模板列表
    setCoursePoint: '/mobileCourses/setCoursePoint2',//课程点赞
    getAppShareList: '/home/getAppShareList',//获取邀模板
    getRecommendList: '/mobileCourses/getRecommendList',//搜索页查询推荐课程列表
    bindMember: '/member/bind',//绑定会员卡
    getBindCardList: '/member/getBindCardList',//查询绑定会员卡列表
    getResPlayUrlForXXT: '/mobileCourses/getResPlayUrlForXXT',//获取音视频播放地址(校讯通)
    ...
    //免费查询2级页面；
    getFreeList: '/mobileCourses/getFreeList',
    //热门课程2级页面；
    getHotList: '/mobileCourses/getHotList',
    //标题分类级页面；
    getListByClassifyIdLabelId: '/mobileCourses/getListByClassifyIdLabelId',
    //二级页面分类列表
    ...
    //分类导航根据分类id查询课程列表
    getListByNavigation2: '/mobileCourses/getListByNavigation2',
    getAllClassify:'/classify/getAllClassify',//获取所有分类
    //获取地区接口
    ...
    //发表评论
    commentSendComment:'/comment/sendComment',
    //验证评论内容违禁词
    commentVerifyProhibitedWord:'/comment/verifyProhibitedWord',
    //举报评论
    commentReportComment:'/comment/reportComment',
    //删除评论
    commentDel:'/comment/del',
    //查询课程评论推荐精华列表
    commentFindRecommendEssenceList:'/comment/findRecommendEssenceList',
    //查询课程评论列表
    commentFindRecommendEssenceListSend:'/comment/findCommentPage',
    //查询课程评论详情回复列表分页  
    commentFindCommentInfoPage: '/comment/findCommentInfoPage',
    



    //首次进入回显
    integralSignItemgetShow: '/integralSignItem/getShow',
    //复活卡签到
    integralSignItemResurgenceSign: '/integralSignItem/ResurgenceSign',
    //签到活动普通打卡
    integralSignItemSign:'/integralSignItem/sign',
    //查询签到活动信息
    integralSignItemGetActivityStatus:'/integralSignItem/getActivityStatus',
    ...
    //获取详情页段视频
    getCourseShortVideoList: '/mobileCourses/getCourseShortVideoList',
    
    //课程详情获取短视频播放地址
    getResPlayUrlForShortVideo: '/mobileCourses/getResPlayUrlForShortVideo',
    getThemeInfo:'/operation/getThemeInfo',//查询主题设置
    getCircleByCourseId:'/mobileCourses/getCircleByCourseId',//查看课程是否设置圈子
    saveStudyBehavior:'/mobileCourses/saveStudyBehavior',//保存用户学习时长（路径）
    createOrder:'/mobilePopup/createOrder',//移动弹窗下单
    clickNum:'/mobilePopup/clickNum',//移动弹窗点击数量
}