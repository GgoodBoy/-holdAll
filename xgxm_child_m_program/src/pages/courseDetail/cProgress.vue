<template>
    ...
    <view class="silder-pluge justifyContent1">
        <view class="control-item">
            <!-- <view class="leftBox"> -->
                <view style="padding:10rpx;" @click="pressClickEven">
                    <image v-if="playFlag" :src="pauseImg" />
                    <image v-else :src="player_btn" />
                </view>
                <view>{{currentTimeResolve}}</view>
            <!-- </view> -->
        </view>
        <view class="pressBox">
            <view class="leftSlot"></view>
            <view class="pressBox-one">
                <van-slider bar-height="2px" use-button-slot :value="percentageVal" active-color="#fff" inactive-color="#fff" @drag-end='dragEnd' @drag='onDrag' @change="onChange">
                    <div slot="button" class="bar-btn" ref="barBtn"></div>
                </van-slider>
            </view>
            <view class="rightSlot"></view>
        </view>
        <view  class="control-item1">
            {{durationResolve}}
        </view>
    </view>    
</template>
<script>
    ...
    export default {
            ...
            props: ['duration','currentTime','playFlag'],   
