<template>
    ...
    <div class="dialog_login" v-show='loginShow'>
        <div class="login">            
            ...
            <div class='loginBut'>  
                <div class='but' @click.stop="loginEvent(true)">
                        登录
                </div>
                <div class='but' @click.stop="loginEvent(false)">
                        取消
                </div>
            </div>
...
.dialog_login{
    ...
    .login{
        ...
        .loginBut{
            ...
            .but:nth-child(1){
                background:linear-gradient(to right,#F74C60,#C30D23);
                color:#fff;
                margin-left: 0.8rem;
            }
        }
