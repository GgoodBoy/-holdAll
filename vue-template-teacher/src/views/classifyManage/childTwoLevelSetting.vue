<template>
    <div class="two-level-tag" @click="hideSort">
        <div class="page-header lMarginBO30">
            ...
            <el-button v-if="$authJudge('classify:appchildrensecond:add')" type="primary" class="my-add-btn lMarginBO10" @click="showDialog">添加</el-button>
        </div>
        <div class="my-table">
            <el-table
                border
                ...
                <el-table-column
                    ...
                    min-width="100">
                        <template slot-scope="scope">
                            ...
                            <div class="btn-box">
                                <el-button v-if="$authJudge('classify:appchildrensecond:sort')" type="text" class="black-btn" @click.stop="sortRow(scope.row)">排序</el-button>
                            </div> 
                            <div class="btn-box">
                                <el-button v-if="$authJudge('classify:appchildrensecond:del')" type="text" class="black-btn" @click="delRow(scope.row)">删除</el-button>
                            </div>                                              
                        </template>                    
                </el-table-column>                                                
            </el-table>
...
export default {
    ...
    methods:{
        ...
        dialogSure(){
            ...
            this.$http.post(`${this.$server.addAppSecondPageClassify}/2`,query).then(res=>{
        ...
        getClassifyList(){
            ...
            this.$http.get(`${this.$server.getClassifyList}/2`,{params}).then(res=>{
                if(res.status==200){
                    let arr = res.content;
                    arr.forEach(item=>{
