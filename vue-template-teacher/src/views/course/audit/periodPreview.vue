<template>
    <div class="periods-wrap preview-period">
        <div class="form-wrap hide-required-asterisk">
            ...
            <el-row type="flex" justify="center">
                <el-col :span="3" style="text-align: center;">
                     <el-button type="primary" @click="histyGoEven">返回</el-button>
                </el-col>
            </el-row>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.periodId = this.$route.query.id;
            if (this.periodId) {
                this.getPeriodInfo();
            } else {
                ...
                this.$http
                    ...
                    .then(res => {
                        ...
                        if (data.isVideo) {
                            ...
                            // this.vid = this.periodVideo["vid"];//targetId
