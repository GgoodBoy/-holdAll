<template>
    <div>
        ...
        <el-row class="lSize24 lPadding20 lLine40 warryBackCss" style="margin:0 20px">
            ...
            <el-col class="redFontColor lLeft-r" :span="23">提示：课程优惠券指定课程可用，用户购买指定课程时，凭券抵扣现金。</el-col>
        </el-row>         
        <el-form ref="form" 
                v-loading = "loadDailg"
                :model="form" 
                ...
                <section class="form-module fontCss14">
                    ...
                    <el-form-item label="使用条件">
                        <el-row>
                            <el-radio>无使用门槛</el-radio>
                        </el-row>
                    </el-form-item>                  
                     <el-form-item label="有效时间" required class="timeDeleteButton">
                        <el-col :span="5">
                    ...
                    <el-form-item label="每人限领" prop="eachLimitGet">
                        <el-row>
                            <el-col :span="4"><el-input placeholder="1" :disabled="true" v-model.number="form.eachLimitGet"></el-input></el-col>
                            <el-col :span="1" class="lCenter-r">张</el-col>
                        </el-row>                        
                    </el-form-item>
...
export default {
    ...
    data(){
            ...
            switch (rule.fullField) {
                ...
                case "beginAt":
                      if (value===""||Number(value)==0) {
                        ...
                        setTimeout(() => {
                            if(this.endTime!=null&&Number(value)>Number(this.endTime)){
               ...
               case "endAt":
                      if (value===""||Number(value)==0) {
                        ...
                        setTimeout(() => {
                            if(this.beginTime!=null&&Number(value)<Number(this.beginTime)){
        ...
        return {
            ...
            courseSourceType:1//自营课程（1）还是三方课程（2）               
    }},
    created(){
        this.form.validDays = "";   
