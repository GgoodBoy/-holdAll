                ...
                <el-form ref="form" 
                        ...
                        <section class="form-module fontCss14">
                           ...
                           <!-- <el-form-item label="类型" prop="useType">
                            ...
                            <el-form-item label="张数" prop="num">
                                <el-row>
                                    <el-col :span="6"><el-input v-model="form.num" placeholder="≥1≤100000"></el-input></el-col>
                                    <el-col :span="1" class="lCenter-r">张</el-col>
                                </el-row>
                            </el-form-item>
                            <el-form-item label="批次" prop="batch">
                                <el-row>
                                    <el-col :span="6"><el-input v-model="form.batch" type="text" maxlength="3" placeholder=" "></el-input></el-col>
                        ...
                        <el-row>
                            <el-col class="lCenter-r">
                                ...
                                <el-button class="lButtomOk lMarginTB50" :loading="loadDailg" @click="submitForm('form')">生成</el-button>
                            </el-col>
                        </el-row>                
                </el-form>
            </el-col>
    ...
    data(){
        ...
        return {
            ...
            titleList:[
                ...
                {
                    name:'活动学习卡',
                    pathInfo:'/marketelist/activitiesCard/activiesLearningCard'
                },
                {
                    name:'新建活动学习卡',
                    pathInfo:''
                ...
                self.$refs[formName].validate((valid) => {
                        if (valid) {
                                ...
                                var parems = {
                                    ...
                                    self.$http.post(self.$server.activityStudyCardAdd,parems).then(res=>{
                                        if(res.status==200){
                                                self.dataUpdateBool = JSON.stringify({});
                                                self.form = {};
                                                self.loadDailg = false; 
