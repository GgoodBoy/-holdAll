<template>
    <div class="module-edit goods">
        <div class="module-edit-header clearfix">
            <p class="title" ref="title">商品</p>
        ...
        <div class="module-edit-body">
            ...
            <div class="select-course">
                <p>商品</p>
                <el-button type="primary" size="medium" @click="showDialog">选择商品</el-button>
            </div>
            <div class="edit-list">
                <div class="edit-item type2 clearfix" v-for="(item,index) in curEditData" :key="index">
                    <p class="course-name">{{item.goodsName}}</p>
                    <div class="btns">
        ...
        <el-dialog :custom-class="'edit-dialog'" :visible.sync="editDialogVisible" :width="'500px'" :show-close="false">
            <el-select v-model="classifyId" :placeholder="'好物列表'" size="medium" class="classify-select">
                <el-option
            ...
            <div class="search-box">
                <el-input placeholder="输入商品名称查询" size="medium" clearable prefix-icon="el-icon-search" v-model="searchKey" maxlength="10" @keypress.native="pressEvent($event)"></el-input>
            ...
            <div class="list" ref="scrollBox">
                <el-checkbox-group
                    ...
                    <div class="item" v-for="(item,index) in editDialogList" :key="index">
                        <el-checkbox :label="item.id" :disabled="item.disabled">{{item.goodsName}}</el-checkbox>
                    </div>
                </el-checkbox-group>
                <el-checkbox-group 
                    v-if="styleVal=='2'"
    ...
    methods:{
        ...
        saveData(){
            ...
            this.curEditData.forEach((item,index)=>{
                query['appHomeRelationRecordFormList['+index+'].title'] = item.goodsName;
                query['appHomeRelationRecordFormList['+index+'].type'] = 11
            ...
            .styles{
                ...
                .real-img{
                    ...
                    &.style1{
                        ...
                        background: url('../../../../assets/images/haowu_small_ys1.png')no-repeat 50% 50% /cover;
                    }
                    &.style2{
                        width: 350px;
                        height: 240px;
                        ...
                        background: url('../../../../assets/images/haowu_small_ys2.png')no-repeat 50% 50% /cover;
                    }
                }
            }
            .number{
