<template>
    <div class="module-edit advertising">
        <div class="module-edit-header clearfix">
            <p class="title" ref="title">通栏广告</p>
        ...
        <div class="module-edit-body">
            ...
            <div class="number">
                ...
                <el-tooltip class="item" effect="dark" :content="settingType=='4'?'最多添加5个':'不限制个数'" placement="right">
                ...
                <div class="edit-item" v-for="(item,index) in curEditData" :key="index">
                    <div class="top clearfix">
                        ...
                        <div class="text-box">
                            ...
                            <div class="banner-type">
                                ...
                                <div class="type2" v-if="item.type=='2'" v-show="settingType=='2'">
                                    <label>资讯</label>
                                ...
                                <div class="type3" v-if="item.type=='3'" v-show="settingType=='2'">
                                    <label>链接</label>
                    ...
                    <div class="bottom">
                        <el-radio-group v-model="item.type">
                            ...
                            <el-radio :label="2"  v-show="settingType=='2'">资讯</el-radio>
                            <el-radio :label="3"  v-show="settingType=='2'">链接</el-radio>
            ...
            .styles{
                ...
                .real-img{
                    ...
                    &.style1{
                        ...
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk1/tlgg/tlgg1.png')no-repeat 50% 50% /cover;
                    }
                    &.style2{
                        width: 345px;
                        height: 100px;
                        border-radius: 5px;
                        transform: scale(0.8) translate(-10%,-10%);
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk1/tlgg/tlgg2.png')no-repeat 50% 50% /cover;
                    }
                }
            }
            .number{
