...
<style lang="scss" scoped>
    .tag-module{
        ...
        .occupancy-map{
            ...
            &.style1{
                height: 140px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk2/bq/ys1.png')no-repeat 50% 50% /cover;
            }
            &.style2{
                height: 158px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk2/bq/ys2.png')no-repeat 50% 50% /cover;
            }
            &.style3{
                height: 158px;
