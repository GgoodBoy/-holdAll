<template>
    <div class="module-edit free-zone">
        <div class="module-edit-header clearfix">
            <p class="title" ref="title">拼团专区</p>
        ...
        <div class="module-edit-body">
            ...
            <div class="clearfix styles">
                ...
                <el-select v-model="styleVal" size="small">
                    <el-option
                        v-for="item in (Number(settingType)!=4?styleOption1:styleOption2)"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                    </el-option>
            ...
            <div class="list" ref="scrollBox">
                <el-checkbox-group
                    ...
                    <div class="item nameTextEllipsis" v-for="(item,index) in editDialogList" :key="index">
                        <el-checkbox :label="item.id" :disabled="item.disabled">{{item.courseTitle}}</el-checkbox>
                        <div style='font-size:14px;'>{{item.coursePrice||0}}币</div>
                    </div>
                </el-checkbox-group>
                <el-checkbox-group 
                    v-if="styleVal=='2'"
...
export default {
    ...
    methods:{
        ...
        getAssembleCourses(item){
            ...
            this.$http.get(this.$server.getAssembleCourses,{params}).then(res=>{
                if(res.status==200){
        ...
        saveData(){
            ...
            this.curEditData.forEach((item,index)=>{
                ...
                query['appHomeRelationRecordFormList['+index+'].type'] = 1 ;//类型(1.课程，2.资讯，3.链接，4.无链接，5.专题，6.标签，7.分类，8.课时，9.老师)
            ...
            .styles{
                ...
                .real-img{
                    ...
                    &.style1{
                        ...
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/mfzq/mfzq1.png')no-repeat 50% 50% /cover;
                    }
                    &.style2{
                        width: 345px;
                        height: 187px;
                        border-radius: 5px;
                        transform: scale(0.8) translate(-10%,-10%);
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/mfzq/mfzq2.png')no-repeat 50% 50% /cover;
                    }
                }
            }
            .number{
