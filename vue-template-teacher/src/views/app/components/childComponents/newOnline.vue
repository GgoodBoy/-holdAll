<template>
    <div class="new-online-module module">
...
<style lang="scss" scoped>
    .new-online-module{
        ...
        .occupancy-map{
            ...
            &.style1{
                height: 184px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk1/zxsx/ys1.png')no-repeat 50% 50% /cover;
            }
            &.style2{
                height: 131px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk1/zxsx/ys2.png')no-repeat 50% 50% /cover;
            }
        }
    }
</style>
