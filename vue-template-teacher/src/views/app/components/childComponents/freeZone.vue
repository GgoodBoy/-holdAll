<template>
    <div class="time-zone-module module">
...
<style lang="scss" scoped>
    .time-zone-module{
        ...
        .occupancy-map{
            ...
            &.style1{
                height: 132px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk2/mfzq/ys1.png')no-repeat 50% 50% /cover;
            }
            &.style2{
                height:184px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/youer/mk2/mfzq/ys2.png')no-repeat 50% 50% /cover;
            }
            &.style3{
                height: 160px;
                background: url('../../../../assets/images/3.png')no-repeat 50% 50% /cover;
            }
        }
    }
</style>
