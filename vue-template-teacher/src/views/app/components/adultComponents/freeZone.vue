...
<style lang="scss" scoped>
    .time-zone-module{
        ...
        .occupancy-map{
            ...
            &.style1{
                height: 86px;
                 background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/mfzq/ys1.png')no-repeat 50% 50% /cover;
            }
            &.style2{
                height: 184px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/mfzq/ys2.png')no-repeat 50% 50% /cover;
            }
        }
    }
</style>
