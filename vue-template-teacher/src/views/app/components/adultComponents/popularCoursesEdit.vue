<template>
    <div class="module-edit popular-courses">
        <div class="module-edit-header clearfix">
            <p class="title" ref="title">热门课程</p>
        ...
        <div class="module-edit-body">
            ...
            <div class="number">
                ...
                <el-tooltip class="item" effect="dark" content="该样式最多可以添加8个" placement="right">
            ...
            if(this.editData.data.length==0){
                if(id==-1){
                    ...
                    let editChildData = [
                        ...
                        {styleType:'3',popularCoursesData:[],active:false}
                    ]
            ...
            this.$http.get(`${url}/${id}`).then(res=>{
                ...
                if(res.status==200){
                    ...
                    let editChildData = [
                        ...
                        {styleType:'3',popularCoursesData:res.content.style==3?popularCoursesData:[],active:res.content.style==3?true:false}
                    ]
                    this.editData.data = editChildData;
            ...
            .styles{
                ...
                .real-img{
                    ...
                    &.style1{
                        ...
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/rmkc/rmkc1.png')no-repeat 50% 50% /cover;
                    }
                    &.style2{
                        width: 345px;
                        height: 187px;
                    ...
                    &.style3{
                        ...
                        border-radius: 5px;
                        transform: scale(0.8) translate(-10%,-10%);
                        background: url('../../../../assets/images/2.png')no-repeat 50% 50% /cover;
                    }
                }
            }
            .number{
