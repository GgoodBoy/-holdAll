<template>
    <div class="module-edit time-zone">
        <div class="module-edit-header clearfix">
            <p class="title" ref="title">限时专区</p>
        ...
        <div class="module-edit-body">
            ...
            <div class="select-course">
                <p>活动</p>
                 <!-- 
                    ...
                    collapse-tags                     
                -->
                <el-select v-model="editData.targetId"
                        clearable 
            ...
            <div class="select-course" v-if="editData.targetId">
                <p>课程</p>
    ...
    methods:{
        ...
        initData(){
            ...
            if(this.editData.data.length==0){
                if(id==-1){
                    this.styleVal = '1';
                    let editChildData = [
                        {styleType:'1',timeZoneData:[],active:true},
                        {styleType:'2',timeZoneData:[],active:false}
                    ]
        ...
        getSubModuleInfoList(id){
            ...
            this.$http.get(`${url}/${id}`).then(res=>{
                ...
                if(res.status==200){
                    ...
                    let timeZoneData = res.content.ahprrList.map((item,index)=>{
                        return {
                    ...
                    let editChildData = [
                        {styleType:'1',timeZoneData:res.content.style==1?timeZoneData:[],active:res.content.style==1?true:false},
                        {styleType:'2',timeZoneData:res.content.style==2?timeZoneData:[],active:res.content.style==2?true:false}
                    ]
                    this.editData.data = editChildData;
                    this.editData.initData = true;
                    this.editData.saveDataFlag = true;
                    this.editData['targetId'] = res.content.targetId;
                }
            })
        },
        /**
        ...
        getTimeLimitCourses(item){
            ...
            let params = {
                pageNo:this.pageNo,
                pageSize:20,
                discountsActivityId:this.editData.targetId,
                mtype:1
            }            
            // this.$http.get(this.$server.getTimeLimitCourses,{params}).then(res=>{
        ...
        saveData(){
            ...
            this.$http.post(url,query,{headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then(res=>{
                ...
                if(res.status==200){
                    ...
                    this.editData.data.find(item=>item.active == false).timeZoneData = []
                    this.editData.inEdit = false;
                    this.editData.saveDataFlag = true;
                    this.$message({
                        message: '保存成功！',
            ...
            .styles{
                ...
                .real-img{
                    ...
                    &.style1{
                        ...
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/xszq/xszq1.png')no-repeat 50% 50% /cover;
                    }
                    &.style2{
                        width: 345px;
                        height: 185px;
                        border-radius: 5px;
                        transform: scale(0.8) translate(-10%,-10%);
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/xszq/xszq2.png')no-repeat 50% 50% /cover;
                    }
                }
            }
            .number{
