...
<style lang="scss" scoped>
    .time-zone-module{
        ...
        .occupancy-map{
            ...
            &.style1{
                height: 86px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/xszq/ys1.png')no-repeat 50% 50% /cover;
            }
            &.style2{
                height: 215px;
               background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/xszq/ys2.png')no-repeat 50% 50% /cover;
            }
        }
    }
</style>
