    ...
    <div class="module-edit columns-courses">
        ...
        <div class="module-edit-body">
            ...
            <div class="number">
                ...
                <el-tooltip class="item" effect="dark" :content="styleVal=='1'?'该样式最多可以添加3个':'该样式最多可以添加8个'" placement="right">
                    <i class="question el-icon-question"></i>
                </el-tooltip>
            </div>
            <p class="tip" v-if="styleVal=='1'">尺寸：690*280<span>支持JPEG、PNG</span></p>
            ...
            <div class="edit-list">
                <div class="edit-item clearfix" :class="styleVal=='2'?'type2':''" v-for="(item,index) in curEditData" :key="index">
                    <div class="img-file-box" @click="uploadFile(index)" v-if="styleVal=='1'">
                    ...
                    <div class="text-box" v-if="styleVal=='1'">
            ...
            <div class="add-btn" v-if="styleVal=='1'"><button class="my-primary-btn" @click="addcolumnCourse" :class="{'not-allow':curEditData.length>=3}"><i class="el-icon-plus"></i><span>添加课程</span></button></div>
        </div>
        <el-dialog :custom-class="'edit-dialog'" :visible.sync="editDialogVisible" :width="'500px'" :show-close="false">
            ...
            <div class="list" ref="scrollBox">
                <el-radio-group v-model="editDialogVal" v-if="styleVal=='1'">
                ...
                image.onload = ()=>{
                    ...
                    if(this.styleVal=='1'){
                        if(width!=690||height!=280){
                            this.$message.error('请上传690*280的图片');
                            return;
                        }
                    }
            ...
            .styles{
                ...
                .real-img{
                    ...
                    &.style1{
                        ...
                        background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk1/tlk/tlk1.png')no-repeat 50% 50% /cover;
                    }
                    &.style2{
                        width: 345px;
                        height:150px;
