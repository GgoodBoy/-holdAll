<template>
    <div class="advertising-module module">
        <p class="module-name clearfix">
            <span class="name">赠课活动</span>
        </p>
...
<style lang="scss" scoped>
    .advertising-module{
        ...
        .occupancy-map{
            ...
            &.style1{
                height: 60px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk1/tlgg/ys1.png')no-repeat 50% 50% /cover;
            }
            &.style2{
                height: 100px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk1/tlgg/ys2.png')no-repeat 50% 50% /cover;
            }
        }
    }
</style>
