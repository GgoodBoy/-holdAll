<template>
    <div class="popular-courses-module module">
...
<style lang="scss" scoped>
    .popular-courses-module{
        ...
        .occupancy-map{
            ...
            &.style1{
                height: 86px;
                 background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/rmkc/ys1.png')no-repeat 50% 50% /cover;
            }
            &.style2{
                height: 184px;
                background: url('https://xgxw-pic.oss-cn-beijing.aliyuncs.com/zwt/chengren/mk2/rmkc/ys2.png')no-repeat 50% 50% /cover;
            }
            &.style3{
                height: 160px;
                background: url('../../../../assets/images/1.png')no-repeat 50% 50% /cover;
            }
        }
    }
</style>
