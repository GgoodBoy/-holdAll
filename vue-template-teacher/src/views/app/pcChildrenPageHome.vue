...
<div  class="page-wrap clearfix">
    ...
    <div style="position:relative">
                ...
                <div class="inner-container">
                    <div class="content">
                        <div v-for="(item, index) in pageItemList"
                            ...
                            <div class="free-courses-box" v-else-if="item.moduleType==='freeGoodCourse'">
        ...
        <!-- 动态切换组件 -->
        <component class="config-info" :type="2" :urlList='urlList' :modeAllInfo="choosemodelInfo" :powerArryList="power" v-bind:is="$store.state.appConfig.chooseModelName" :key="keysId"></component>
        <mobiledelete :objHome="objList" :mobiledIsOk="saveMobiledelete" :powerArryList="power" v-show="mobileType!=''?true:false" :soleid="choosemodelInfo.id" v-on:removeChooseId="removeModelChooseId" :from="'child'"></mobiledelete>
    </div>
    <!-- 推存弹框 -->
    <el-dialog
...
import timeZone from "@/components/Appconfigpage/TimeZone/timeZoneNew";// timeZone: [], //限时专区
...
import freeGoodCourse from "@/components/Appconfigpage/freeCourses/freeCourses"
...
export default {
    ...
    data() {
        return {
            ...
            urlList:{
                ...
                type:4,
                selectUrlAll:"/appIndexConfigs/selectAll?type=4"
                },            
            // pageItemList: [],
    ...
    created(){
        ...
        var getAppInfo= function (){
            ...
            self.$http.get("/appIndexConfigs/selectAll?type=4")
            .then(res => {
                if (res.status === 200) {
    ...
    methods: {
        ...
        addModule(item,i){
                    ...
                    if(item.type=='teacherRecommend'||item.type=='freeGoodCourse'||item.type=='timeZone'){
                        obfInfo.list = []
                    }
