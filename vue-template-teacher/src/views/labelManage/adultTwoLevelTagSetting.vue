<template>
    <div class="two-level-tag" @click="hideSort">
        <div class="page-header lMarginBO30">
            <span class="page-title">APP成人二级页标签设置</span>
            <el-button v-if="$authJudge('label:appadultsecond:add')" type="primary" class="my-add-btn" @click="showDialog">添加</el-button>
        </div>
        <div class="my-table">
            <el-table
                border
                ...
                <el-table-column
                    ...
                    min-width="100">
                        <template slot-scope="scope">
                            ...
                            <div class="btn-box">
                                <el-button v-if="$authJudge('label:appadultsecond:sort')" type="text" class="black-btn" @click.stop="sortRow(scope.row)">排序</el-button>
                            </div> 
                            <div class="btn-box">
                                <el-button v-if="$authJudge('label:appadultsecond:del')" type="text" class="black-btn" @click="delRow(scope.row)">删除</el-button>
                            </div>                                              
                        </template>                    
                </el-table-column>                                                
            </el-table>
...
export default {
    ...
    methods:{
        ...
        dialogSure(){
            ...
            this.$http.post(`${this.$server.addAppSecondPageLabel}/1`,query).then(res=>{
                if(res.status==200){
