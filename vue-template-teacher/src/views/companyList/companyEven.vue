        ...
        <el-row>
            ...
            <el-col :span="18" class="lMarginTop20">
                ...
                <div class="my-course-editor">
                    <Editor v-model="introduce" :maxLength="5000"/>
                </div>                
            </el-col>
            <el-col :span="18" class="lCenter-r lMarginTop20" v-if="$authJudge('set:bigevent:release')">
                <el-button class="redBackColor butColorF" @click="submitForm(2)">发布</el-button>                
            </el-col>            
        </el-row>
    </div>
</template>
