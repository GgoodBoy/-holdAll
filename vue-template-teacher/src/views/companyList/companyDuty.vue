<template>
    <div>
        ...
        <el-row>
            ...
            <el-col :span="18" class="lCenter-r lMarginTop20" v-if="$authJudge('set:disclaimer:release')">
                <el-button class="redBackColor butColorF" @click="submitForm(6)">发布</el-button>                
            </el-col>            
        </el-row>
    </div>
</template>
