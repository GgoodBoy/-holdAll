<template>
    <div>
        ...
        <el-row>
            ...
            <el-col :span="18" class="lCenter-r lMarginTop20" v-if="$authJudge('set:contactus:release')">
                <el-button class="redBackColor butColorF" @click="submitForm(4)">发布</el-button>                
            </el-col>            
        </el-row>
    </div>
</template>
