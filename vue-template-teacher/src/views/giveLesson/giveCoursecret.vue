        ...
        <el-container>
            <el-main>
                <el-row class="lMarginTB20">
                    ...
                    <el-col :span="9" class="lLine40">已选择<span class="redFontColor">{{changeChooseIdlist.length}}</span>门课程</el-col>
                </el-row>
                <el-row>
                    <el-table
                        v-loading = "loadDailg"
...
export default {
    ...
    props:['varObjs',"courseType","numbersBool","urlPorp","chooseIdlist","relevanceId","locaCourseIds"],
    computed:{},
    methods:{
        ...
        ajaxData(){
            ...
            var getAppInfo= function (){
                    ...
                    if(self.courseType=="course"){
                        ...
                        self.$http.get(self.urlPorp, { params: {name:self.input2,pageNo:1,pageSize:9999,type:0}})
                                    .then(res => {
                                        console.log(res)
                                        if (res.status === 200) {
                                            deferred.resolve(res.content.list);
