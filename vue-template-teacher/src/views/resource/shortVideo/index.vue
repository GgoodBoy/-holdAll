<template>
    <div class="resouce-shorrt-video">
        <div class="page-header">
            <!-- <div class="page-title">
                <h3 @click="$router.push('/resource/video')">视频库</h3>
                <h3 class="active">短视频库</h3>
            </div> -->
            <el-row>
            ...
            <el-button class="red-btn"
                        v-if="$authJudge('source:shortvideo:select')"
            ...
            <div class="handle-row clearfix">
                ...
                <div class="fr clearfix">
                    <el-button type="info"
                               class="del-btn fl"
                               size="mini"
                               @click="deleteTeacher" v-if="$authJudge('source:shortvideo:del')">删除</el-button>
                    <el-button type="primary"
                                v-if="$authJudge('source:shortvideo:upload')"
                               class="upload-video red-btn fl"
                               @click="$router.push('/resource/shortVideoCreateByAli')"
                               size="mini">上传视频</el-button>
                    <!-- <el-button type="primary"
                                v-if="$authJudge('source:shortvideo:upload')"
                               class="upload-video red-btn fl"
                               @click="$router.push('/resource/shortVideoCreate')"
                               size="mini">上传视频</el-button>                                -->
                </div>
            </div>
...
export default {
    ...
    components: { pagination, playVideo ,breadcrumb},
    watch: {
        $route() {
            this.init();
        }
    ...
    methods: {
        ...
        search() {
            this.$router.push(`/resource/shortVideo?title=${this.title}`);
        },
        deleteTeacher() {
