        ...
        <el-row class="lLine40 headerDiv">
            ...
            <el-col class="lRight-r">
                <el-row :gutter="20">
                    ...
                    <el-col :span="2" :offset="3"><el-button v-if="$authJudge('statistics:coursesale:select')" type="primary" @click="findInfo">查询</el-button></el-col>
                    <el-col :span="2" v-if="$authJudge('statistics:coursesale:export')"><el-button type="primary"  @click="exportLearnList">导出</el-button></el-col>
                </el-row>
            </el-col>
        </el-row>  
        <el-row>
    ...
    methods:{
        ...
        exportLearnList(){
            ...
            var parems = {
                ...
                endAt:Number(self.dataEnd)>0?actions.formatDate(Number(self.dataEnd)+86399000):''                
            };
            window.open(this.$server.exportStatistics(parems));            
        },
        //状态筛选
        chooseVersionType(e){
            this.value = e;
        ...
        getCountlist(num){
            ...
            this.$http.get(this.$server.courseStatistics(parmes)).then(res=>{
               if(res.status==200){
