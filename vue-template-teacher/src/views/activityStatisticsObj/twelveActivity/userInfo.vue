        ...
        data(){
            return{
                ...
                titleList:[
                        ...
                        {
                            name:'十二月活动数据统计',
                            pathInfo:'/activityStatistics/twelveActivity/activityStatistics'
                        },
                        {
                            name:'数据详情',
                            pathInfo:''
                ...
                // 1.APP主页 2.测一测二维码H5 3.摇一摇二维码H5 4.M站 5.微信群 6.微信公众号 7.端外1 8.端外2 9.端外3 10.端外4
                options1:[
                    {
                        value:-1,
                        label:' 全部'
        ...
        getRegionList(){
            ...
            exportEven(){
                ...
                if(self.activeIndex==1){
                    ...
                    var url = self.$server.userDetailList+"?channelType="+parems.channelType+"&cellphone="+parems.cellphone+"&beginAt="+parems.beginAt+"&endAt="+parems.endAt+"&provinceId="+parems.provinceId+"&cityId="+parems.cityId+"&token="+getToken();  
                    ...
                    var url = self.$server.OrderDetailList+"?channelType="+parems.channelType+"&cellphone="+parems.cellphone+"&beginAt="+parems.beginAt+"&endAt="+parems.endAt+"&channelType2="+parems.channelType2+"&orderStatus="+parems.orderStatus+"&token="+getToken();            
                }else{
                    parems = {
                        channelType:self.typeId,
                        cellphone:self.inputInfo,
                    ...
                    var url = self.$server.userVisitDetail+"?channelType="+parems.channelType+"&tellphone="+parems.cellphone+"&regBeginAt="+parems.beginAt+"&regEndAt="+parems.endAt+"&visitBeginAt="+parems.beginAtNext+"&visitEndAt="+parems.endAtNext+"&provinceId="+parems.provinceId+"&cityId="+parems.cityId+"&token="+getToken();                      
                }   
                window.open(url);                   
            }, 
            getTableList(num){
                ...
                if(self.activeIndex==1){
                    ...
                    url = this.$server.getUserDetailByChannel;
                }else if(self.activeIndex==2){
                    query = {
                        params:{
                            channelType:self.typeId,
                    ...
                    url = this.$server.getOrderDetailByChannel;                  
                }else{
                    query = {
                        params:{
                            channelType:self.typeId,
                    ...
                    url = this.$server.getUserVisitDetail;                  
                }
