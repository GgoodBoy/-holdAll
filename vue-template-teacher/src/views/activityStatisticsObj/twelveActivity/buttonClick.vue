            ...
            */
            ...
            exportEven(type){
                ...
                if(type==1){
                    ...
                    url = self.$server.exportButtonList+"?type="+parems.type+"&courseId="+parems.courseId+"&beginAt="+parems.beginAt+"&endAt="+parems.endAt+"&token="+getToken();                    
                }else{
                    url = self.$server.exportButtonListAll+"?token="+getToken();                   
                }    
                window.open(url);                    
            }, 
            loadMore(){
            ...
            getButtonDataList(num){
                ...
                this.loading = true;            
                self.$http.get(self.$server.getButtonList,query).then(res=>{
                    if(res.status==200){
                        this.loading = false;
