        ...
        <div class="page-head">
            <div class="queryBox">
                <div class="queryOne">
                    ...
                    <el-date-picker type="date" :placeholder="(activeIndex==1)?'注册时间':'访问开始时间'" style="width:170px;margin-right:5px;" v-model="beginAt"></el-date-picker>
                ...
                <el-table-column
                    ...
                    label="详情">
                        <template slot-scope="scope">
                            <div @click='goToUserDetail(scope.row)' style="color:#9E0E00;cursor: pointer;">详情</div>
                        </template>                    
                </el-table-column>                
            </el-table>
        </div>
...
<script type="text/ecmascript-6">
    ...
    export default{
        ...
        created(){
            this.activeIndex = Number(this.$route.params["selectId"])||null;
            this.typeId = this.$route.params["pid"] || null;
            this.getRegionList();
            this.getTableList(1);
        },
        watch: {
        ...
        getRegionList(){
            ...
            exportEven(){
                ...
                if(self.activeIndex==1){
                    ...
                    var url = self.$server.exportUserDetailList+"?channelType="+parems.channelType+"&cellphone="+parems.cellphone+"&beginAt="+parems.beginAt+"&endAt="+parems.endAt+"&provinceId="+parems.provinceId+"&cityId="+parems.cityId+"&token="+getToken();  
                    ...
                    var url = self.$server.exportUserDetailByChannelRd+"?channelType="+parems.channelType+"&cellphone="+parems.cellphone+"&beginAt="+parems.beginAt+"&endAt="+parems.endAt+"&token="+getToken();            
                } 
                window.open(url);                   
            }, 
            getTableList(num){
                ...
                if(self.activeIndex==1){
                    ...
                    url = this.$server.getRegisterUserDetailRd;
                }else if(self.activeIndex==2){
                    query = {
                        params:{
                            channelType:self.typeId,
                    ...
                    url = this.$server.getUserDetailByChannelRd;                  
                }
