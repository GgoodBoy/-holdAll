<template>
    <div class="page-wrap springFestival-but-page">
        ...
        methods:{
            ...
            exportEven(type){
                ...
                if(type==1){
                    ...
                    url = self.$server.fuBaoexportButtonList+"?type="+parems.type+"&beginAt="+parems.beginAt+"&endAt="+parems.endAt+"&token="+getToken();                    
                }else{
                    url = self.$server.fuBaoexportButtonListAll+"?token="+getToken();                   
                }    
                window.open(url);                    
            }, 
            childPageValue(num){
            ...
            getButtonDataList(num){
                ...
                this.loading = true;            
                self.$http.get(self.$server.getFuBaoButtonList,query).then(res=>{
                    if(res.status==200){
                        this.loading = false;
