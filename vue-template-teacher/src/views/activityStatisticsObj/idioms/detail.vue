    ...
    export default{
        ...
        created(){
            ...
            this.titleList = [
                        ...
                        {
                            name:'数据详情',
                            pathInfo:'/activityStatistics/idioms/idiomsDetail/'+this.userIds+"?type="+this.typeId
                        },
                        {
                            name:'详情',
                            pathInfo:''
        ...
        formatDate(date,type){
            ...
            exportEven(){
                ...
                if(self.activeIndex==1){
                    var url = self.$server.ciExportInviteUserList+self.userIds+"?token="+getToken();  
                }else{
                    var url = self.$server.ciExportUserScoreList+self.userIds+"?token="+getToken();            
                }
                window.open(url);                   
            }, 
            getTableList(num){
                ...
                if(self.activeIndex==1){
                    ...
                    url = this.$server.ciInviteUserList+self.userIds;
                }else {
                    query = {
                        params:{
                            pageNo:self.pageNo,
                    ...
                    url = this.$server.ciUserScoreList+self.userIds;                  
                }
