<template>
    <div class="page-wrap cgt-activity-statis-page">
        ...
        <div class="page-head">
            ...
            <div class="flexBox">
                <p>活动总付费人数</p>
                <p>
                    <span>{{baseData.peopleNum}}</span>人
                </p>
                <p>总金额：{{baseData.amount}} 元</p>
            </div>
        </div>
...
import breadcrumb from "@/components/breadcrumbGX/breadcrumb";
    export default{
        ...
        methods:{
            ...
            getActivityBaseData(){
                var self = this;
                self.$http.get(self.$server.cgtGetActivityBaseData).then(res=>{
                    if(res.status==200){
            ...
            getTableInfoList(num){
                ...
                self.loading = true;
                self.$http.get(self.$server.cgtGetListByChannel).then(res=>{
                    if(res.status==200){
                        self.loading = false;
