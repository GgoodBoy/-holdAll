        ...
        <div class="page-head">
            <div class="queryBox">
                <div class="queryOne">
                    ...
                    <el-date-picker type="date" placeholder="选择时间" style="width:150px;margin-right:5px;margin-left:5px;" v-model="beginAt"></el-date-picker>
        ...
        methods:{
            ...
            exportEven(type){
                ...
                if(type==1){
                    ...
                    url = self.$server.packExportButtonList+"?type="+parems.type+"&beginAt="+parems.beginAt+"&endAt="+parems.endAt+"&token="+getToken();                    
                }else{
                    url = self.$server.packExportButtonList+"?token="+getToken();                   
                }    
                window.open(url);                    
            }, 
            // loadMore(){
            ...
            getButtonDataList(num){
                ...
                this.loading = true;            
                self.$http.get(self.$server.getPackButtonList,query).then(res=>{
                    if(res.status==200){
                        this.loading = false;
