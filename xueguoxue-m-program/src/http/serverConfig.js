export default {
    ...
    // getResoursePlayUrl:'/courses/getWechatResoursePlayUrl',   //xcx获取音视频播放地址 old
    ...
    getPeriodsListByCourseIdCourses:'/appletCourses/getWechatPeriodsListByCourseId',   //xcx根据课程ID查询课时信息列表
    // 获取我的优惠券列表
    ...
    // searchWechatCourseList:'/courses/searchWechatCourseList',//课程搜索 old
    searchWechatCourseList:'/appletCourses/searchWechatCourseList',//课程搜索
    ...
    //获取用户信息
    getloginWeChatGetUserInfo:'/login/loginWeChatGetUserInfo'
}